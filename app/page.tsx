    ...
    <>
      ...
      <main className="flex-1 flex flex-col gap-6 px-4 max-w-[690px] mx-auto">
        <div className="grid grid-cols-1 gap-8">
          <div className="flex flex-col items-center p-6 rounded-lg bg-[#9CE8DF80] dark:bg-[#BF941280]">
          ...
          <div className="flex flex-col items-center p-6 rounded-lg bg-[#FFE8A380] dark:bg-[#3AB9AA80]">
            <h2 className="text-xl font-normal mb-4">
          ...
          <div className="flex flex-col items-center p-6 rounded-lg bg-[#9CF3C180] dark:bg-[#19197080]">
            <h2 className="text-xl font-normal mb-4">
